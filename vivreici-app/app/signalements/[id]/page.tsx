...
export default function SignalementDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-white pb-6">
      <AppTopbar title={report?.type ?? "Détail"} backHref="/signalements" />
      ...
      <div className="mx-auto max-w-md space-y-4 px-4 pt-4">
        ...
        {isLoading ? (
          ...
          <div className="py-6 text-sm text-[#7A1C22]">
          ...
          <div className="space-y-5 py-1">
            ...
            {statusFeedback ? (
              <div className="rounded-2xl bg-[#ECFDF3] px-4 py-3 text-sm font-medium text-[#027A48]">
                {statusFeedback}
              </div>
            ) : null}
            ...
            {canReportAbuse ? (
              <div className="space-y-3 rounded-[24px] bg-[#FBFBFB] p-4 ring-1 ring-gray-100">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {abuseFeedback ? (
                    <p className="text-xs text-gray-500">{abuseFeedback}</p>
                  ) : null}
                </div>
              </div>
            ) : null}
            ...
            {isEditing && canEditDetails ? (
              <div className="space-y-4 border-b border-gray-100 pb-5">
                ...
                <button
                  ...
                  onClick={handleSave}
                  disabled={isSaving}
                  className="inline-flex h-12 items-center rounded-full bg-[#fac411] px-5 text-sm font-semibold text-white disabled:opacity-60"
                >
