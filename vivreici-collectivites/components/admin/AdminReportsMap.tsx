...
export default function AdminReportsMap({
  ...
  if (visibleReports.length === 0) {
    return (
      <div className="flex h-[560px] items-center justify-center rounded-[30px] border border-dashed border-[#0337AA]/14 bg-white text-sm text-[#5B6572]">
  ...
  return (
    <div className="h-[560px] overflow-hidden rounded-[30px] border border-[#0337AA]/8 bg-white shadow-[0_14px_44px_rgba(3,55,170,0.1)]">
      <MapContainer
        center={center}
        zoom={12}
        scrollWheelZoom
