...
export const REPORT_SELECT_WITH_ARCHIVE =
  "id, user_id, report_number, report_type_number, lat, lng, type, status, description, photo_url, address_text, territory_name, territory_key, created_at, updated_at, archived_at, expires_at, deleted_at, confidence_score, confidence_level, confidence_reasons, confidence_version, confidence_updated_at"

export const REPORT_SELECT_WITH_HISTORY =
  "id, user_id, report_number, report_type_number, lat, lng, type, status, description, photo_url, address_text, territory_name, territory_key, created_at, updated_at, expires_at, deleted_at, confidence_score, confidence_level, confidence_reasons, confidence_version, confidence_updated_at"

export const REPORT_SELECT_LEGACY =
  "id, user_id, report_number, report_type_number, lat, lng, type, status, description, photo_url, address_text, territory_name, territory_key, created_at"

export const MAP_REPORT_SELECT_WITH_ARCHIVE =
  "id, report_number, report_type_number, lat, lng, type, status, description, photo_url, address_text, territory_name, created_at, updated_at, archived_at, deleted_at"

export const MAP_REPORT_SELECT_WITH_HISTORY =
  "id, report_number, report_type_number, lat, lng, type, status, description, photo_url, address_text, territory_name, created_at, updated_at, deleted_at"

export const MAP_REPORT_SELECT_LEGACY =
  "id, report_number, report_type_number, lat, lng, type, status, description, photo_url, address_text, territory_name, created_at"
...
export function parseStoredReportMetadata(description: string | null) {
  ...
  return {
    ...
    address: address ?? reportAddressFallback(description),
    mediaUrls,
  }
}

function reportAddressFallback(description: string | null) {
  if (!description) {
    return null
  }

  const matched = description.match(/Adresse indiquée :([^\n]+)/)
