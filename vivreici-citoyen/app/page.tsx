    ...
    <div className="relative min-h-screen overflow-hidden bg-[#F5F5F5]">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 pt-10 pb-16 text-center">
        ...
        <div className="mt-10 flex flex-col items-center gap-3">
          <Link
            href="/inscription"
            className="flex h-14 w-[250px] items-center justify-center rounded-full bg-[#fac411] px-8 text-sm font-semibold text-[#1A1A1A] shadow-[0_14px_30px_rgba(250,196,17,0.24)] transition hover:bg-[#E0AF00] sm:w-[320px]"
          >
            Inscription
          </Link>
          <Link
