    ...
    <div className="min-h-screen bg-white pb-24">
      ...
      <div className="mx-auto max-w-md px-4 pt-4">
        ...
        {!isLoading && loadNotice ? (
          <FeedbackBanner variant="warning" className="mb-3">
            {loadNotice}
          </FeedbackBanner>
        ) : null}
                  ...
                  >
                    {notification.metadata?.actorName ? (
                      <div className="mb-3 flex items-center gap-3">
                        {notification.metadata.actorAvatarUrl ? (
                          <Image
                            src={notification.metadata.actorAvatarUrl}
                          ...
                          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#E5E7EB] text-sm font-semibold text-[#4B5563]">
                            {notification.metadata.actorName.slice(0, 2).toUpperCase()}
                          </div>
                        )}
