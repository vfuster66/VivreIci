...
function InscriptionPageContent() {
  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      <AppTopbar title="Inscription" backHref={backHref} />

      <div className="mx-auto max-w-md px-4 pt-4">
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              <label htmlFor="signup-first-name" className="text-sm font-semibold text-[#1A1A1A]">
                Prénom
              </label>
              <input
            ...
            <div className="space-y-2">
              <label htmlFor="signup-last-name" className="text-sm font-semibold text-[#1A1A1A]">
                Nom
              </label>
              <input
                id="signup-last-name"
          ...
          {successMessage ? (
            <p className="text-sm text-[#027A48]" role="status" aria-live="polite">
              {successMessage}
            </p>
          ) : null}
